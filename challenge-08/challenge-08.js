...
*/
console.log(`O nome da função que faz a soma é ${sum().nome}`);
...
*/
`A função ${varShowName.name} retorna ${varShowName(x,y)}`
...
*/
soma(10,2); // Resultado da operação: 10  +  2 =  12.
...
console.log(mod(10,2)); //Operação inválida!