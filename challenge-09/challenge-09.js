...
subtraction(function(num1,num2){ return num1 - num2}); // 4

console.log( 'O resultado da multiplicação é:' );
multiplication(function(num1,num2){ return num1 * num2;}); //25

console.log( 'O resultado da divisão é:' );
division(function(num1, num2){ return num1 / num2}); //2

console.log( 'O resto da divisão é:' );
mod(function(num1,num2){return num1 % num2;}); //0